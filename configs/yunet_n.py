...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/home/rohit/Projects/Face_Det/Models/YuNet/custom_train/libfacedetection.train/data/test02/labelv2/train/labelv2.txt',
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file='/home/rohit/Projects/Face_Det/Models/YuNet/custom_train/libfacedetection.train/data/test02/labelv2/val/labelv2.txt',
